...
the generates instruction was stored in the staticInst. 
...
should be taken or not-taken. Also, note that the reference of the nextPC is passed
to the branch predictor. This is because the prediction affects the next instruction's address.
