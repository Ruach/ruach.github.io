...
183 };
```
The advancePC function will end up invoking the advance of the base class, SimplePCState.
It just updates the _pc as the _npc which has been measured as a result of adding size of instruction
