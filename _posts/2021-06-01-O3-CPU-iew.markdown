...
and set proper flags of the instruction object to indicate 
the instruction initiated the TLB access. 

Regardless of this condition, 
we can retrieve the request object, so 
The translationStarted function makes the instruction set proper flag
indicating the TLB translation has been started. 
