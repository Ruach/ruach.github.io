...
%
\vspace{4pt}
\resumeItem{Led Live Firmware Activation (LFA) support for RMM, building the software stack across \emph{RMM, ATF, and Vera IROT}.}
%
\resumeItem{Hardened guest OS boot sequence and model loading using initramfs disk encryption with early attested key provisioning.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Managed and mentored a group of 20 Ph.D. students.}
