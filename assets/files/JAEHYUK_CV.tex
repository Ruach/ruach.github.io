...
\emph{I am interested in computer systems security, especially in:  hardware/software codesign for security, Trusted Execution Environment (TEE), secure IO design for TEE, software/hardware vulnerability research, side-channel attacks and mitigations, and fuzzing}%, and sharing knowledge through blogging}
\vspace{-3pt}
%
...
\begin{itemize}[leftmargin=0.18in, itemsep=0pt, topsep=0pt]
    \item Implemented cross-layer firmware support across \emph{RMM, ATF, PSCFW (IROT), and Caliptra DPE} to enable end-to-end \emph{Vera CCA} evidence generation.
    \item Implemented the software stack to enable \emph{Baremetal Secure AI} attestation evidence generation for Vera and Grace CPUs.
...
\begin{itemize}[leftmargin=0.18in, itemsep=0pt, topsep=0pt]
    \item Built the supporting software stack across \emph{RMM, ATF, and Vera IROT} to enable live firmware activation.
\end{itemize}
%
