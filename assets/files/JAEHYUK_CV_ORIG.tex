...
\newcommand{\resumeSubHeadingListStart}{\begin{itemize}[leftmargin=0.0in, label={}, itemsep=8pt, topsep=2pt]}
...
\begin{interestbox}
\small\emph{I am interested in computer systems security, with a focus on hardware/software co-design for security, Trusted Execution Environments (TEEs), secure I/O design, building verifiable chains of trust through secure boot and cryptographic attestation, and vulnerability research including side-channel attacks and mitigations, and fuzzing.}
\end{interestbox}
\vspace{-3pt}
%
...
\section{PUBLICATION \& PATENT \small\href{https://scholar.google.com/citations?user=nfpCTgUAAAAJ&hl=en}{(828 citations)}}
...
autofz            & USENIX Sec.'23 &  21 & \textcolor{gray!80}{\rule{5pt}{4pt}}  & User-space \\
